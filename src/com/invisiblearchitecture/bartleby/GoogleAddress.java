...
/**
 * @author realest
 * GoogleAddress is a wrapper for android.location.address with UniversalAddress.  It also
 * provides a geocoder feature via the android libraries.
 */
public class GoogleAddress implements UniversalAddress {
	...
	public static abstract class ViaGeocoder extends AsyncTask<Void, Integer, UniversalAddress> {
		 ...
		 * is an interruption during these attempts, it must be handled by handleCanclled().
		 */
		@Override
